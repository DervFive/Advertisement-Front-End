      ...
      <div className="">
        <div className="max-w-sm w-full bg-[#2D0F59] shadow-lg rounded-lg p-6 border border-black py-12 px-16">
          <form className="flex flex-col items-center w-full gap-3">
            ...
            <Link to={"/vendor-Login"} className="w-full">
              <button className=" py-2 px-4 rounded-lg bg-[#FACB09] hover:text-white hover:bg-[#0EBCF1] transition duration-300 flex justify-center w-full font-bold text-[#FE4E51]">
                Vendor
              </button>
            </Link>
