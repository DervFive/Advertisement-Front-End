        ...
        <form>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <div>
                ...
                <div className=" flex justify-start items-center gap-1 w-full bg-gray-800">
                  <span className="ml-1 font-bold"><i class="fa-regular fa-user"></i></span>
                  <input
            ...
            <div className=" flex justify-start items-center gap-1 w-full  bg-gray-800 ">
              ...
              <span className="ml-1 font-bold"><i class="fa-regular fa-circle-user"></i></span>
              <input
            ...
            <span>email</span>
            <div className=" flex justify-start items-center gap-1 w-full  bg-gray-800 "><span className="ml-1 font-bold"><i class="fa-regular fa-envelope"></i></span>
              <input
                className="w-[90%] bg-transparent rounded-md p-2 focus:ring-2 focus:ring-gray-500"
                type="text"
            ...
            <span>Password</span>
            <div className=" flex justify-start items-center gap-1 w-full  bg-gray-800 ">
              <span className="ml-1 font-bold"><i class="fa-solid fa-lock"></i></span>
              <input
          ...
          <div className="flex justify-center mt-8">
            ...
            <Link to={'/customer-Login'}><span className="text-yellow-500">Login</span></Link>
          </div>
